...
Assert-Contains $scriptText 'CDB_SAME_FREE_THREAD_ALLOC_RETURN' "Same-free-thread allocation target diagnostic tag is missing"
Assert-Contains $scriptText 'CDB_SAME_FREE_THREAD_ALLOC_STACK' "Same-free-thread allocation stack diagnostic tag is missing"
...
Assert-Contains $scriptText 'r\s+@\$t19\s*=\s*0' "Same-free-thread allocation stack counter is not initialized"
